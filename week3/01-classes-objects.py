...
#__init__ is a special method name, it tells python that when you create a new instance of Counter2 call this method first. If the class is a blueprint, then the constructor method "builds" an new instance of the class, creating an object.         
